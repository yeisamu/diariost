...
<input type="hidden" id="order" value="id_prop">
<input type="hidden" id="corder" value="id_prop">   
...
<input type="hidden" id="idapp" value="<?php echo $app_ID; ?>">
	<div class="content" style="padding:0 5px 0 5px">
			...
			<div class="row">
				<div class="col-xs-10">
					<h1 style="font-size: 25px;">Gesti&oacute;n propietarios<small></small></h1>
				</div><!--.col-->
			                 ...
			                 <div class="input-group">
			                 	...
			                 	<div class="inputer  inputer-indigo">
			                 		<div class="input-wrapper">
			                 			<input type="text" class="form-control" id="buscaprop" placeholder="Buscar">
			                 		    <span class="ion-android-close reseteaprop form-control-feedback cursor hide">
			                 		    </span>
			                 		</div>
			                 	</div>
			                 </div>
			...
			<div class="element_hide restar_div">
			    <table class="table table-condensed col-md-12x margin_0 bck_table" style="font-size: 13px;">
			            <tr>
			               ...
			               <th  width="8%" style="padding-left: 5px;border: 1px solid #ddd;">
			               	<span class="hidden-md hidden-sm" >Fecha Exp</span>
			               	<span class="visible-md visible-sm" >F</span>

			               </th>
			               <th  width="20%" style="padding-left: 5px;border: 1px solid #ddd;">
			               	 <!-- <div class="col-md-12 orderby" data-div="#busqueda_list" 
                                 data-vars="?order=nombre&tipo=list&app_ID=<?php echo $app_ID; ?>" data-control="listar_tabla_prop"  data-value="nombre" style="display: inline-table;cursor:pointer;">-->
								<span class="" > <!-- <i class="fa fa-sort hidden-md  hidden-sm"></i> --> Propietario</span>
							 <!-- </div> -->
			               	</th>
			               <th  width="8%" style="padding-left: 5px;border: 1px solid #ddd;">Fecha Nacimiento</th>
			    ...
			    <table class="table table-condensed span12 table-bordered margin_0 bck_table">
			        <thead>
			            <tr style="border-bottom:none !important;">
			                <td style="border-bottom:none !important;"> Documento
			                    <i class="fa fa-angle-right gray"></i> Fecha Exp
			                    <i class="fa fa-angle-right gray"></i> Nombre
			                    <i class="fa fa-angle-right gray"></i> Fecha Nac.
			                    <i class="fa fa-angle-right gray"></i> Direccion
			                </td>
			            </tr>
			        </thead>
			    </table>
	           ...
	           if($(this)[0].scrollHeight - $(this).scrollTop() == $(this).outerHeight()) {
	               if (parseFloat(sgcapp.page) >= parseFloat(sgcapp.pages)) {
	                   //========================+'&search='+$('#search_general').val()
	               	  ...
	               	  if($('#buscaprop').val()!=''){
	               	  	 var paramfound='&search='+$('#buscaprop').val()+'&app_ID=<?php echo $app_ID; ?>';
	               	  }else{
	               	  	var paramfound="";
	               	  }
	               	  var vg=$('#filtrog').val();
                      ...
                      var orderby = $('#orderby').val();
	                   ...
	                   var params = '<?php echo base_url() ?>sart.php/sistemasart/listar_tabla_prop?page='+sgcapp.page+paramfi+parini+'&order='+order+'&by='+orderby+paramfound+'&tipo=list'+'&app_ID=<?php echo $app_ID; ?>';
	                   $.ajax({
	                       url: params,
	                       type: "POST",
	                       async: true,
